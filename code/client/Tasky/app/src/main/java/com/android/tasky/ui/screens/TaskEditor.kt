...
class TaskEditor : ComponentActivity(){
...
fun TaskEdit() {
    ...
    var statoSelezionato by remember { mutableStateOf(task.stato)}
    var testoDescrizione by remember { mutableStateOf(task.descrizione) }
            ...
            Row(
                ...
                ExposedDropdownMenuBox(
                    ...
                    OutlinedTextField(
                        ...
                        value = statoSelezionato?.nome ?: "Seleziona uno stato",
                        readOnly = true,
                        onValueChange = {},
                        textStyle = TextStyle(
    ...
    Column(
        ...
        Box(
            ...
            Text(
                "Stato: ", //Inserire il nome del dipendente
                textAlign = TextAlign.Center,
                fontFamily = computerSaysNo,
                fontWeight = FontWeight.W400,
                fontSize = 40.sp,
